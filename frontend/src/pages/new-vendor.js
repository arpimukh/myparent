...
export default function NewVendor() {
  ...
  return (
    <>
      <Head>
        <title>Vendor Registration - Parent Care Services</title>
        <meta name="description" content="Join our network of compassionate care service providers" />
      ...
      <section style={{
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 16px' }}>
          <h1 style={{ fontSize: '3rem', fontWeight: 'bold', marginBottom: '16px' }}>
            Compassionate Parent Care Vendor Services
          </h1>
          <p style={{ fontSize: '1.2rem', opacity: '0.9', maxWidth: '600px', margin: '0 auto' }}>
            Join our network of trusted service providers and help families care for their loved ones
          </p>
        </div>
      </section>
      ...
      <section style={{ padding: '64px 0', backgroundColor: 'white' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 16px' }}>
          ...
          <p style={{ 
            ...
            Our mission is to provide peace of mind to families by offering reliable, professional care services tailored to
